...
//     await Provider.of<ManageIncomingResourceDonation>(context, listen: false)
//         .getAllIncomingResourceDonation(profile, accessToken);
//     setState(() {
//       _isLoading = false;
//     });
//     await clearList();
...
//         Provider.of<ManageIncomingResourceDonation>(context).listOfRequests;
