                  ...
                  children: [
                    ...
                    matchedResources.isEmpty
                        ? Container(
                            ...
                            child: Center(
                                child: Text(
                                    "No matched resources yet. Discover more at our explore section.",
                    ...
                    Tags(
                      key: _tagStateKey,
                      itemCount:
                          widget.project.relatedResources.length, // required
                    ...
                    recommendedResourcesCountry.isEmpty
                        ...
                        : Container(
                            height:
                                recommendedResourcesCountry.length.toDouble() *
                                    80,
                            width: double.infinity,
                            child: ListView.builder(
                              physics: BouncingScrollPhysics(),
                                  ...
                                  child: Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Container(
                                        height: 70,
                                        color:
                                            AppTheme.project3.withOpacity(0.3),
                                        child: Row(
                                          children: <Widget>[
                                            Container(
                                              color: Colors.red,
