                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          ...
                          children: <Widget>[
                            AttachmentImage(
                              spotLightProjects[index].projectProfilePic,
                            ),
                            Positioned(
                              left: 0,
                              bottom: 0,
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: Text(
                                      spotLightProjects[index].projectTitle,
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 15,
                                          fontWeight: FontWeight.w500,
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          ...
                          children: <Widget>[
                            AttachmentImage(
                              spotLightResources[index].resourceProfilePic,
                            ),
                            Positioned(
                              left: 0,
                              bottom: 0,
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Padding(
                                    padding: const EdgeInsets.all(10.0),
                                    child: Text(
                                      spotLightResources[index].resourceName,
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 15,
                                          fontWeight: FontWeight.w500,
