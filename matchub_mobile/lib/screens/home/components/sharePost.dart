...
import 'package:matchub_mobile/screens/home/components/postCard.dart';
              ...
              Container(
                ...
                child: SingleChildScrollView(
                  ...
                  Container(
                    ...
                    child: PostCard(post: widget.originalPost, isRepost: true,)
                  ),
                  Container(
    ...
    if (controller.text.isNotEmpty && formController.currentState.validate()) {
      ...
      Post createdPost = Post.fromJson(
        await ApiBaseHelper.instance.postProtected(
          "authenticated/repost?originalPostId=${widget.originalPost.postId}",
          body: json.encode({
