            ...
            children: [
              ...
              Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                          onTap: () async {
                            String fileName = (widget
                                .competition.documents[documentKeys[index]]);
                    ...
                    itemCount:
                        widget.competition.documents.keys.toList().length),
              ),
              Row(
                ...
                children: [
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(widget.competition.projects.length.toString(),
                              style: TextStyle(
                  ...
                  Column(
                    children: [
                      Row(
                        children: [
                          Icon(Icons.star, size: 24, color: Colors.grey[700]),
                          SizedBox(
                            width: 5,
                          ),
                          Text(widget.competition.prizeMoney.toString(),
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.w500)),
                        ],
                      ),
                ...
                children: [
                  FlatButton(
                    ...
                    onPressed: () {
                      Navigator.of(
                        context,
                      ).pushNamed(JoinCompetition.routeName,
                                ...
                                children: <Widget>[
                                  RaisedButton(
                                    ...
                                    child: Text(
                                      'Vote',
                                      style:
                                          TextStyle(color: AppTheme.project2),
                                    ),
                                    onPressed: () => _votingDialog(context, p),
                                  ),
                                ],
                              ),
                              // FlatButton(
