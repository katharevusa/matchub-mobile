...
class BoardView2 extends StatefulWidget {
  ...
  BoardView2({Key key, this.itemInMiddleWidget,this.boardViewController,this.onDropItemInMiddleWidget, this.isSelecting = false, this.lists, this.width = 280, this.middleWidget, this.bottomPadding}) : super(key: key);
...
class BoardView2State extends State<BoardView2> {
  ...
  PageController boardViewController = new PageController(viewportFraction: 0.88);
