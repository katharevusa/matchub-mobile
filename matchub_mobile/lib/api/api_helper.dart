      ...
      case 400:
        ...
        if (errors.isEmpty) {
          responseJson['errorMessage'] != null
              ? errors += responseJson['errorMessage']
              : errors += responseJson['error_description'];
        }
